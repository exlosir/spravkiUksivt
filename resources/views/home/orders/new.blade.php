...
{{-- Начало блока добавления приказа --}}
    ...
    <div class="card-body">
        <form action="{{ route('add_new_order')}}" method="POST" class="w-auto">
                {{ csrf_field() }}
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text">Номер</span>
                </div>
                <input type="text" name="number" class="form-control" placeholder="145">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text">Дата</span>
                </div>
                <input type="date" name="date" class="form-control" placeholder="27.08.2018">
            </div>
